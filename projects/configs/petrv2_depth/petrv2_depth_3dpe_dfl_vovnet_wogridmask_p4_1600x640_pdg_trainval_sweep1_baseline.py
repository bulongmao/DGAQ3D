...
# Clean 3DPPE 1600x640 train-only one-sweep PGD baseline.
#
# This is the paired temporal baseline for the keyframe config. It changes
# only the temporal input semantics: one historical six-camera sweep is
# appended and timestamp encoding is enabled. Data split, DD3D initialization,
# optimizer, learning rate, batch size, augmentation and detector remain
# identical to the keyframe baseline. Validation uses a deterministic sweep.
# Epochs 22--26 are evaluated and their five checkpoints are retained.
...
# Lock the late-epoch comparison protocol.
total_epochs = 26
runner = dict(type='EpochBasedRunner', max_epochs=total_epochs)
checkpoint_config = dict(interval=1, max_keep_ckpts=5)
work_dir = 'work_dirs/clean_3dppe_1600_sweep1_trainonly_e26_dd3d'
